...
const styles = StyleSheet.create({
  card: {
    ...
    borderRadius: 16,
    alignItems: "stretch",
    // Sombra sutil para dar profundidad (Android usa elevation).
    shadowColor: "#000",
    shadowOpacity: 0.08,
    shadowRadius: 8,
  ...
  thumb: { width: 80, height: 80, borderRadius: 12, backgroundColor: "#F3EFE7" },
  ...
  precio: { fontSize: 18, fontWeight: "900", color: "#C2680E" },
  precioCerrada: { textDecorationLine: "line-through", color: "#9CA3AF" },
  tienda: { flex: 1, fontSize: 12, color: "#8B7B69" },
  ...
  chipOpciones: { fontSize: 11, fontWeight: "600", color: "#C2680E" },
  ...
  qtyBtn: { width: 32, height: 32, borderRadius: 999, alignItems: "center", justifyContent: "center" },
