...
const styles = StyleSheet.create({
  ...
  precioBadge: { alignSelf: "flex-start", flexDirection: "row", alignItems: "baseline", backgroundColor: "#F28C28", paddingHorizontal: 10, paddingVertical: 3, borderRadius: 999, marginTop: 8 },
