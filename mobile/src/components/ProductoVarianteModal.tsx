...
const styles = StyleSheet.create({
  ...
  chipActive: { borderColor: "#F2A65A", backgroundColor: "#FEF5EA" },
  chipText: { fontSize: 13, color: "#4B5563" },
  chipTextActive: { color: "#F2A65A", fontWeight: "700" },
  ...
  opcionRowActive: { borderColor: "#F2A65A", backgroundColor: "#FEF5EA" },
  opcionNombre: { flex: 1, fontSize: 14, color: "#4B5563" },
  opcionNombreActive: { color: "#F2A65A", fontWeight: "700" },
  ...
  submit: { backgroundColor: "#F2A65A", borderRadius: 999, paddingVertical: 14, alignItems: "center" },
