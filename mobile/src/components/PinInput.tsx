...
const styles = StyleSheet.create({
  ...
  slotFilled: { borderColor: "#FF7A2B", backgroundColor: "#FFF2E5" },
  slotCursor: { borderColor: "#FF7A2B", borderWidth: 2 },
  slotError: { borderColor: "#DC2626" },
  dot: { width: 12, height: 12, borderRadius: 6, backgroundColor: "#FF7A2B" },
