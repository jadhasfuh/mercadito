...
const styles = StyleSheet.create({
  ...
  toggleBtnOn: { backgroundColor: "#ED8E3C", borderColor: "#ED8E3C" },
  ...
  tiendaChipOn: { backgroundColor: "#ED8E3C", borderColor: "#ED8E3C" },
  ...
  metodoBtnOn: { backgroundColor: "#ED8E3C", borderColor: "#ED8E3C" },
  ...
  btnGuardar: { backgroundColor: "#ED8E3C", paddingVertical: 14, borderRadius: 12, alignItems: "center" },
