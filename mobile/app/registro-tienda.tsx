...
const styles = StyleSheet.create({
  ...
  btn: { flexDirection: "row", gap: 8, justifyContent: "center", alignItems: "center", backgroundColor: "#FF7A2B", borderRadius: 999, paddingVertical: 14, marginTop: 4 },
  ...
  linkBold: { color: "#C2410C", fontWeight: "700" },
  ...
  credLine: { fontSize: 14, color: "#C2410C", marginBottom: 2 },
