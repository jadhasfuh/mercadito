  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-lg mx-auto px-4 pb-24">
        ...
        <div className="mt-4 bg-amber-50 border-2 border-amber-300 rounded-2xl p-6 text-center">
          ...
          <p className="text-xs text-gray-400 mt-3">
            ¿Ya te registraste? <Link href="/tienda" className="text-amber-600 font-medium underline">Entra aqui</Link>
          </p>
        </div>
