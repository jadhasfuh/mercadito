...
// aplica a un repartidor que va por un paquete. Mismas claves DB, distinto
// texto al usuario. Mantener sincronizado con mobile/src/lib/estadoPedido.ts.
...
/** Label corto para badges/chips (pocas letras). */
...
/** Texto del botón de avance del repartidor. */
